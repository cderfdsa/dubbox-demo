...
public class CryptUtil {
	...
	public static String encrypt(String value, byte[] key) {
		return Base64.encodeBase64URLSafeString(CryptUtil.encrypt(value.getBytes(), key));
	}
	...
	public static String decrypt(String value, byte[] key) {
		try {
			...
			return new String(CryptUtil.decrypt(data, key));
	...
	public static byte[] encrypt(byte[] src, byte[] key) {
		...
		try {
			...
			System.out.println("CryptUtils encrypt()---Exception" + e);
			return null;
		}
	}
