...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		function showError(itemDiv, msg) {
			...
			K('.ke-common', itemDiv).addClass('ke-error').show().html(K.escape(msg));
		}
	...
	appendFile : function(file) {
		...
		// common
		K('<div class="ke-common">' + self.options.pendingMessage + '</div>').appendTo(statusDiv);
...
/* **********************************
	...
	for debug common to be sent.  The Debug Console adds
