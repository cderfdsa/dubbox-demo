...
+function ($) {
    ...
    window.FRAG = {
        ...
        alertBoxFrag: '<div id="bjui-alertMsgBox" class="bjui-alert"><div class="alertContent"><div class="#type#"><div class="alertInner"><h1><i class="fa #fa#"></i>#title#</h1><div class="msg">#common##prompt#</div></div><div class="toolBar clearfix"><ul>#btnFragment#</ul></div></div></div></div>',
...
+function ($) {
    ...
    Datagrid.DEFAULTS = {
        ...
        delConfirm      : true,     // Delete confirmation common, Optional 'true' | 'false' | 'common', (Optional 'true, false' is a boolean)
